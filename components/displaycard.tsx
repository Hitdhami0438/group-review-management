...
const defaultCards: DisplayCardProps[] = [
  ...
  },
  {
    ...
    icon: <MessageCircle className="size-4 text-purple-400" />,
    title: "Community",
    description: "Join conversations and events",
    date: "Today",
  ...
  },
  {
    ...
    title: "Achievements",
    description: "Explore your badges and ranks",
    date: "Yesterday",
...
function DisplayCard({
  ...
  title = "Featured",
  description = "Discover amazing group and member",
  date = "Just now",
